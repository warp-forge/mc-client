...
public class DataFixers {
   ...
   public static CompletableFuture optimize(final Set typesToOptimize) {
   ...
   private static UnaryOperator createRenamerNoNamespace(final Map map) {
      return (id) -> (String)map.getOrDefault(id, id);
   }

   private static UnaryOperator createRenamer(final Map map) {
      return (id) -> (String)map.getOrDefault(NamespacedSchema.ensureNamespaced(id), id);
   }

   private static UnaryOperator createRenamer(final String from, final String to) {
