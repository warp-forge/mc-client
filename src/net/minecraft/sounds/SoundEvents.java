...
public class SoundEvents {
   ...
   public static final Holder.Reference AMBIENT_CAVE = registerForHolder("ambient.cave");
   public static final Holder.Reference AMBIENT_BASALT_DELTAS_ADDITIONS = registerForHolder("ambient.basalt_deltas.additions");
   public static final Holder.Reference AMBIENT_BASALT_DELTAS_LOOP = registerForHolder("ambient.basalt_deltas.loop");
   public static final Holder.Reference AMBIENT_BASALT_DELTAS_MOOD = registerForHolder("ambient.basalt_deltas.mood");
   public static final Holder.Reference AMBIENT_CRIMSON_FOREST_ADDITIONS = registerForHolder("ambient.crimson_forest.additions");
   public static final Holder.Reference AMBIENT_CRIMSON_FOREST_LOOP = registerForHolder("ambient.crimson_forest.loop");
   public static final Holder.Reference AMBIENT_CRIMSON_FOREST_MOOD = registerForHolder("ambient.crimson_forest.mood");
   public static final Holder.Reference AMBIENT_NETHER_WASTES_ADDITIONS = registerForHolder("ambient.nether_wastes.additions");
   public static final Holder.Reference AMBIENT_NETHER_WASTES_LOOP = registerForHolder("ambient.nether_wastes.loop");
   public static final Holder.Reference AMBIENT_NETHER_WASTES_MOOD = registerForHolder("ambient.nether_wastes.mood");
   public static final Holder.Reference AMBIENT_SOUL_SAND_VALLEY_ADDITIONS = registerForHolder("ambient.soul_sand_valley.additions");
   public static final Holder.Reference AMBIENT_SOUL_SAND_VALLEY_LOOP = registerForHolder("ambient.soul_sand_valley.loop");
   public static final Holder.Reference AMBIENT_SOUL_SAND_VALLEY_MOOD = registerForHolder("ambient.soul_sand_valley.mood");
   public static final Holder.Reference AMBIENT_WARPED_FOREST_ADDITIONS = registerForHolder("ambient.warped_forest.additions");
   public static final Holder.Reference AMBIENT_WARPED_FOREST_LOOP = registerForHolder("ambient.warped_forest.loop");
   public static final Holder.Reference AMBIENT_WARPED_FOREST_MOOD = registerForHolder("ambient.warped_forest.mood");
   ...
   public static final Holder ARMOR_EQUIP_CHAIN = registerForHolder("item.armor.equip_chain");
   public static final Holder ARMOR_EQUIP_DIAMOND = registerForHolder("item.armor.equip_diamond");
   public static final Holder ARMOR_EQUIP_ELYTRA = registerForHolder("item.armor.equip_elytra");
   public static final Holder ARMOR_EQUIP_GENERIC = registerForHolder("item.armor.equip_generic");
   public static final Holder ARMOR_EQUIP_GOLD = registerForHolder("item.armor.equip_gold");
   public static final Holder ARMOR_EQUIP_IRON = registerForHolder("item.armor.equip_iron");
   public static final Holder ARMOR_EQUIP_LEATHER = registerForHolder("item.armor.equip_leather");
   public static final Holder ARMOR_EQUIP_COPPER = registerForHolder("item.armor.equip_copper");
   public static final Holder ARMOR_EQUIP_NETHERITE = registerForHolder("item.armor.equip_netherite");
   public static final Holder ARMOR_EQUIP_TURTLE = registerForHolder("item.armor.equip_turtle");
   public static final Holder ARMOR_EQUIP_WOLF = registerForHolder("item.armor.equip_wolf");
   public static final SoundEvent ARMOR_UNEQUIP_WOLF = register("item.armor.unequip_wolf");
   public static final Holder.Reference ARMOR_EQUIP_NAUTILUS = registerForHolder("item.armor.equip_nautilus");
   public static final Holder.Reference ARMOR_UNEQUIP_NAUTILUS = registerForHolder("item.armor.unequip_nautilus");
   ...
   public static final Holder.Reference BREEZE_WIND_CHARGE_BURST = registerForHolder("entity.breeze.wind_burst");
   ...
   public static final Holder.Reference CAMEL_HUSK_SADDLE = registerForHolder("entity.camel_husk.saddle");
   ...
   public static final Holder.Reference CAMEL_SADDLE = registerForHolder("entity.camel.saddle");
   ...
   public static final Holder CROSSBOW_LOADING_END = registerForHolder("item.crossbow.loading_end");
   public static final Holder CROSSBOW_LOADING_MIDDLE = registerForHolder("item.crossbow.loading_middle");
   public static final Holder CROSSBOW_LOADING_START = registerForHolder("item.crossbow.loading_start");
   public static final Holder CROSSBOW_QUICK_CHARGE_1 = registerForHolder("item.crossbow.quick_charge_1");
   public static final Holder CROSSBOW_QUICK_CHARGE_2 = registerForHolder("item.crossbow.quick_charge_2");
   public static final Holder CROSSBOW_QUICK_CHARGE_3 = registerForHolder("item.crossbow.quick_charge_3");
   ...
   public static final Holder.Reference GENERIC_DRINK = registerForHolder("entity.generic.drink");
   public static final Holder.Reference GENERIC_EAT = registerForHolder("entity.generic.eat");
   public static final Holder.Reference GENERIC_EXPLODE = registerForHolder("entity.generic.explode");
   ...
   public static final Holder.Reference HARNESS_EQUIP = registerForHolder("entity.happy_ghast.equip");
   ...
   public static final Holder.Reference HONEY_DRINK = registerForHolder("item.honey_bottle.drink");
   public static final int GOAT_HORN_VARIANT_COUNT = 8;
   public static final ImmutableList GOAT_HORN_SOUND_VARIANTS = registerGoatHornSoundVariants();
   ...
   public static final Holder.Reference HORSE_ARMOR_UNEQUIP = registerForHolder("item.horse_armor.unequip");
   ...
   public static final Holder.Reference HORSE_SADDLE = registerForHolder("entity.horse.saddle");
   ...
   public static final Holder.Reference ITEM_BREAK = registerForHolder("entity.item.break");
   ...
   public static final Holder.Reference LLAMA_SWAG = registerForHolder("entity.llama.swag");
   public static final Holder.Reference LLAMA_CARPET_UNEQUIP = registerForHolder("item.llama_carpet.unequip");
   ...
   public static final Holder LUNGE_1 = registerForHolder("item.spear.lunge_1");
   public static final Holder LUNGE_2 = registerForHolder("item.spear.lunge_2");
   public static final Holder LUNGE_3 = registerForHolder("item.spear.lunge_3");
   ...
   public static final Holder.Reference MUSIC_CREATIVE = registerForHolder("music.creative");
   public static final Holder.Reference MUSIC_CREDITS = registerForHolder("music.credits");
   public static final Holder.Reference MUSIC_DISC_5 = registerForHolder("music_disc.5");
   public static final Holder.Reference MUSIC_DISC_11 = registerForHolder("music_disc.11");
   public static final Holder.Reference MUSIC_DISC_13 = registerForHolder("music_disc.13");
   public static final Holder.Reference MUSIC_DISC_BLOCKS = registerForHolder("music_disc.blocks");
   public static final Holder.Reference MUSIC_DISC_CAT = registerForHolder("music_disc.cat");
   public static final Holder.Reference MUSIC_DISC_CHIRP = registerForHolder("music_disc.chirp");
   public static final Holder.Reference MUSIC_DISC_FAR = registerForHolder("music_disc.far");
   public static final Holder.Reference MUSIC_DISC_LAVA_CHICKEN = registerForHolder("music_disc.lava_chicken");
   public static final Holder.Reference MUSIC_DISC_MALL = registerForHolder("music_disc.mall");
   public static final Holder.Reference MUSIC_DISC_MELLOHI = registerForHolder("music_disc.mellohi");
   public static final Holder.Reference MUSIC_DISC_PIGSTEP = registerForHolder("music_disc.pigstep");
   public static final Holder.Reference MUSIC_DISC_STAL = registerForHolder("music_disc.stal");
   public static final Holder.Reference MUSIC_DISC_STRAD = registerForHolder("music_disc.strad");
   public static final Holder.Reference MUSIC_DISC_WAIT = registerForHolder("music_disc.wait");
   public static final Holder.Reference MUSIC_DISC_WARD = registerForHolder("music_disc.ward");
   public static final Holder.Reference MUSIC_DISC_OTHERSIDE = registerForHolder("music_disc.otherside");
   public static final Holder.Reference MUSIC_DISC_RELIC = registerForHolder("music_disc.relic");
   public static final Holder.Reference MUSIC_DISC_CREATOR = registerForHolder("music_disc.creator");
   public static final Holder.Reference MUSIC_DISC_CREATOR_MUSIC_BOX = registerForHolder("music_disc.creator_music_box");
   public static final Holder.Reference MUSIC_DISC_PRECIPICE = registerForHolder("music_disc.precipice");
   public static final Holder.Reference MUSIC_DISC_TEARS = registerForHolder("music_disc.tears");
   public static final Holder.Reference MUSIC_DRAGON = registerForHolder("music.dragon");
   public static final Holder.Reference MUSIC_END = registerForHolder("music.end");
   public static final Holder.Reference MUSIC_GAME = registerForHolder("music.game");
   public static final Holder.Reference MUSIC_MENU = registerForHolder("music.menu");
   public static final Holder.Reference MUSIC_BIOME_BASALT_DELTAS = registerForHolder("music.nether.basalt_deltas");
   public static final Holder.Reference MUSIC_BIOME_CRIMSON_FOREST = registerForHolder("music.nether.crimson_forest");
   public static final Holder.Reference MUSIC_BIOME_DEEP_DARK = registerForHolder("music.overworld.deep_dark");
   public static final Holder.Reference MUSIC_BIOME_DRIPSTONE_CAVES = registerForHolder("music.overworld.dripstone_caves");
   public static final Holder.Reference MUSIC_BIOME_GROVE = registerForHolder("music.overworld.grove");
   public static final Holder.Reference MUSIC_BIOME_JAGGED_PEAKS = registerForHolder("music.overworld.jagged_peaks");
   public static final Holder.Reference MUSIC_BIOME_LUSH_CAVES = registerForHolder("music.overworld.lush_caves");
   public static final Holder.Reference MUSIC_BIOME_SWAMP = registerForHolder("music.overworld.swamp");
   public static final Holder.Reference MUSIC_BIOME_FOREST = registerForHolder("music.overworld.forest");
   public static final Holder.Reference MUSIC_BIOME_OLD_GROWTH_TAIGA = registerForHolder("music.overworld.old_growth_taiga");
   public static final Holder.Reference MUSIC_BIOME_MEADOW = registerForHolder("music.overworld.meadow");
   public static final Holder.Reference MUSIC_BIOME_CHERRY_GROVE = registerForHolder("music.overworld.cherry_grove");
   public static final Holder.Reference MUSIC_BIOME_NETHER_WASTES = registerForHolder("music.nether.nether_wastes");
   public static final Holder.Reference MUSIC_BIOME_FROZEN_PEAKS = registerForHolder("music.overworld.frozen_peaks");
   public static final Holder.Reference MUSIC_BIOME_SNOWY_SLOPES = registerForHolder("music.overworld.snowy_slopes");
   public static final Holder.Reference MUSIC_BIOME_SOUL_SAND_VALLEY = registerForHolder("music.nether.soul_sand_valley");
   public static final Holder.Reference MUSIC_BIOME_STONY_PEAKS = registerForHolder("music.overworld.stony_peaks");
   public static final Holder.Reference MUSIC_BIOME_WARPED_FOREST = registerForHolder("music.nether.warped_forest");
   public static final Holder.Reference MUSIC_BIOME_FLOWER_FOREST = registerForHolder("music.overworld.flower_forest");
   public static final Holder.Reference MUSIC_BIOME_DESERT = registerForHolder("music.overworld.desert");
   public static final Holder.Reference MUSIC_BIOME_BADLANDS = registerForHolder("music.overworld.badlands");
   public static final Holder.Reference MUSIC_BIOME_JUNGLE = registerForHolder("music.overworld.jungle");
   public static final Holder.Reference MUSIC_BIOME_SPARSE_JUNGLE = registerForHolder("music.overworld.sparse_jungle");
   public static final Holder.Reference MUSIC_BIOME_BAMBOO_JUNGLE = registerForHolder("music.overworld.bamboo_jungle");
   public static final Holder.Reference MUSIC_UNDER_WATER = registerForHolder("music.under_water");
   ...
   public static final Holder.Reference NOTE_BLOCK_BASEDRUM = registerForHolder("block.note_block.basedrum");
   public static final Holder.Reference NOTE_BLOCK_BASS = registerForHolder("block.note_block.bass");
   public static final Holder.Reference NOTE_BLOCK_BELL = registerForHolder("block.note_block.bell");
   public static final Holder.Reference NOTE_BLOCK_CHIME = registerForHolder("block.note_block.chime");
   public static final Holder.Reference NOTE_BLOCK_FLUTE = registerForHolder("block.note_block.flute");
   public static final Holder.Reference NOTE_BLOCK_GUITAR = registerForHolder("block.note_block.guitar");
   public static final Holder.Reference NOTE_BLOCK_HARP = registerForHolder("block.note_block.harp");
   public static final Holder.Reference NOTE_BLOCK_HAT = registerForHolder("block.note_block.hat");
   public static final Holder.Reference NOTE_BLOCK_PLING = registerForHolder("block.note_block.pling");
   public static final Holder.Reference NOTE_BLOCK_SNARE = registerForHolder("block.note_block.snare");
   public static final Holder.Reference NOTE_BLOCK_XYLOPHONE = registerForHolder("block.note_block.xylophone");
   public static final Holder.Reference NOTE_BLOCK_IRON_XYLOPHONE = registerForHolder("block.note_block.iron_xylophone");
   public static final Holder.Reference NOTE_BLOCK_COW_BELL = registerForHolder("block.note_block.cow_bell");
   public static final Holder.Reference NOTE_BLOCK_DIDGERIDOO = registerForHolder("block.note_block.didgeridoo");
   public static final Holder.Reference NOTE_BLOCK_BIT = registerForHolder("block.note_block.bit");
   public static final Holder.Reference NOTE_BLOCK_BANJO = registerForHolder("block.note_block.banjo");
   public static final Holder.Reference NOTE_BLOCK_IMITATE_ZOMBIE = registerForHolder("block.note_block.imitate.zombie");
   public static final Holder.Reference NOTE_BLOCK_IMITATE_SKELETON = registerForHolder("block.note_block.imitate.skeleton");
   public static final Holder.Reference NOTE_BLOCK_IMITATE_CREEPER = registerForHolder("block.note_block.imitate.creeper");
   public static final Holder.Reference NOTE_BLOCK_IMITATE_ENDER_DRAGON = registerForHolder("block.note_block.imitate.ender_dragon");
   public static final Holder.Reference NOTE_BLOCK_IMITATE_WITHER_SKELETON = registerForHolder("block.note_block.imitate.wither_skeleton");
   public static final Holder.Reference NOTE_BLOCK_IMITATE_PIGLIN = registerForHolder("block.note_block.imitate.piglin");
   ...
   public static final Holder.Reference OMINOUS_BOTTLE_DISPOSE = registerForHolder("item.ominous_bottle.dispose");
   ...
   public static final Holder.Reference PIG_SADDLE = registerForHolder("entity.pig.saddle");
   ...
   public static final Holder.Reference RAID_HORN = registerForHolder("event.raid.horn");
   ...
   public static final Holder.Reference RESPAWN_ANCHOR_DEPLETE = registerForHolder("block.respawn_anchor.deplete");
   ...
   public static final Holder.Reference SHIELD_BLOCK = registerForHolder("item.shield.block");
   public static final Holder.Reference SHIELD_BREAK = registerForHolder("item.shield.break");
   ...
   public static final Holder.Reference SOUL_ESCAPE = registerForHolder("particle.soul_escape");
   ...
   public static final Holder SPEAR_USE = registerForHolder("item.spear.use");
   public static final Holder SPEAR_HIT = registerForHolder("item.spear.hit");
   public static final Holder SPEAR_ATTACK = registerForHolder("item.spear.attack");
   public static final Holder SPEAR_WOOD_USE = registerForHolder("item.spear_wood.use");
   public static final Holder SPEAR_WOOD_HIT = registerForHolder("item.spear_wood.hit");
   public static final Holder SPEAR_WOOD_ATTACK = registerForHolder("item.spear_wood.attack");
   ...
   public static final Holder.Reference STRIDER_SADDLE = registerForHolder("entity.strider.saddle");
   ...
   public static final Holder TRIDENT_RIPTIDE_1 = registerForHolder("item.trident.riptide_1");
   public static final Holder TRIDENT_RIPTIDE_2 = registerForHolder("item.trident.riptide_2");
   public static final Holder TRIDENT_RIPTIDE_3 = registerForHolder("item.trident.riptide_3");
   public static final Holder TRIDENT_THROW = registerForHolder("item.trident.throw");
   public static final Holder TRIDENT_THUNDER = registerForHolder("item.trident.thunder");
   ...
   public static final Holder.Reference UI_BUTTON_CLICK = registerForHolder("ui.button.click");
   ...
   public static final Holder.Reference WIND_CHARGE_BURST = registerForHolder("entity.wind_charge.wind_burst");
   ...
   public static final Holder.Reference WOLF_ARMOR_BREAK = registerForHolder("item.wolf_armor.break");
   public static final Holder.Reference WOLF_AMBIENT_BABY = registerForHolder("entity.baby_wolf.ambient");
   ...
   public static final Holder.Reference WOLF_DEATH_BABY = registerForHolder("entity.baby_wolf.death");
   public static final Holder.Reference WOLF_GROWL_BABY = registerForHolder("entity.baby_wolf.growl");
   public static final Holder.Reference WOLF_HURT_BABY = registerForHolder("entity.baby_wolf.hurt");
   public static final Holder.Reference WOLF_PANT_BABY = registerForHolder("entity.baby_wolf.pant");
   public static final SoundEvent WOLF_SHAKE = register("entity.wolf.shake");
   public static final Holder.Reference WOLF_STEP = registerForHolder("entity.wolf.step");
   public static final Holder.Reference WOLF_STEP_BABY = registerForHolder("entity.baby_wolf.step");
   public static final Holder.Reference WOLF_WHINE_BABY = registerForHolder("entity.baby_wolf.whine");
   public static final Map WOLF_SOUNDS = registerWolfSoundVariants();
   ...
   public static final Holder.Reference SADDLE_UNEQUIP = registerForHolder("item.saddle.unequip");
   public static final Holder.Reference NAUTILUS_SADDLE_UNDERWATER_EQUIP = registerForHolder("item.nautilus_saddle_underwater_equip");
   public static final Holder.Reference NAUTILUS_SADDLE_EQUIP = registerForHolder("item.nautilus_saddle_equip");

   private static Holder register(final Identifier id, final Identifier soundId, final float range) {
      return Registry.registerForHolder(BuiltInRegistries.SOUND_EVENT, (Identifier)id, SoundEvent.createFixedRangeEvent(soundId, range));
   }
   ...
   private static Holder.Reference registerForHolder(final String id) {
      return registerForHolder(Identifier.withDefaultNamespace(id));
   }

   private static Holder.Reference registerForHolder(final Identifier id) {
   ...
   private static Holder.Reference registerForHolder(final Identifier id, final Identifier soundId) {
      return Registry.registerForHolder(BuiltInRegistries.SOUND_EVENT, (Identifier)id, SoundEvent.createVariableRangeEvent(soundId));
   }

   private static ImmutableList registerGoatHornSoundVariants() {
   ...
   private static Map registerWolfSoundVariants() {
