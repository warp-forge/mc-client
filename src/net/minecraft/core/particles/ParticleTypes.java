...
public class ParticleTypes {
   ...
   public static final ParticleType BLOCK = register("block", false, BlockParticleOption::codec, BlockParticleOption::streamCodec);
   public static final ParticleType BLOCK_MARKER = register("block_marker", true, BlockParticleOption::codec, BlockParticleOption::streamCodec);
   ...
   public static final ParticleType DRAGON_BREATH = register("dragon_breath", false, PowerParticleOption::codec, PowerParticleOption::streamCodec);
   ...
   public static final ParticleType DUST = register("dust", false, (t) -> DustParticleOptions.CODEC, (t) -> DustParticleOptions.STREAM_CODEC);
   public static final ParticleType DUST_COLOR_TRANSITION = register("dust_color_transition", false, (t) -> DustColorTransitionOptions.CODEC, (t) -> DustColorTransitionOptions.STREAM_CODEC);
   public static final ParticleType EFFECT = register("effect", false, SpellParticleOption::codec, SpellParticleOption::streamCodec);
   ...
   public static final ParticleType ENTITY_EFFECT = register("entity_effect", false, ColorParticleOption::codec, ColorParticleOption::streamCodec);
   ...
   public static final ParticleType FALLING_DUST = register("falling_dust", false, BlockParticleOption::codec, BlockParticleOption::streamCodec);
   ...
   public static final ParticleType TINTED_LEAVES = register("tinted_leaves", false, ColorParticleOption::codec, ColorParticleOption::streamCodec);
   public static final SimpleParticleType SCULK_SOUL = register("sculk_soul", false);
   public static final ParticleType SCULK_CHARGE = register("sculk_charge", true, (t) -> SculkChargeParticleOptions.CODEC, (t) -> SculkChargeParticleOptions.STREAM_CODEC);
   ...
   public static final ParticleType FLASH = register("flash", false, ColorParticleOption::codec, ColorParticleOption::streamCodec);
   ...
   public static final ParticleType INSTANT_EFFECT = register("instant_effect", false, SpellParticleOption::codec, SpellParticleOption::streamCodec);
   public static final ParticleType ITEM = register("item", false, ItemParticleOption::codec, ItemParticleOption::streamCodec);
   public static final ParticleType VIBRATION = register("vibration", true, (t) -> VibrationParticleOption.CODEC, (t) -> VibrationParticleOption.STREAM_CODEC);
   public static final ParticleType TRAIL = register("trail", false, (t) -> TrailParticleOption.CODEC, (t) -> TrailParticleOption.STREAM_CODEC);
   ...
   public static final ParticleType SHRIEK = register("shriek", false, (t) -> ShriekParticleOption.CODEC, (t) -> ShriekParticleOption.STREAM_CODEC);
   ...
   public static final ParticleType DUST_PILLAR = register("dust_pillar", false, BlockParticleOption::codec, BlockParticleOption::streamCodec);
   ...
   public static final ParticleType BLOCK_CRUMBLE = register("block_crumble", false, BlockParticleOption::codec, BlockParticleOption::streamCodec);
   ...
   private static ParticleType register(final String name, final boolean overrideLimiter, final Function codec, final Function streamCodec) {
      return (ParticleType)Registry.register(BuiltInRegistries.PARTICLE_TYPE, (String)name, new ParticleType(overrideLimiter) {
