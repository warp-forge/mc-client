...
public class CoralFanBlock extends BaseCoralFanBlock {
   public static final MapCodec CODEC = RecordCodecBuilder.mapCodec((i) -> i.group(CoralBlock.DEAD_CORAL_FIELD.forGetter((b) -> b.deadBlock), propertiesCodec()).apply(i, CoralFanBlock::new));
