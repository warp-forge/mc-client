...
public class DecoratedPotPatterns {
   public static final ResourceKey BLANK = create("blank");
   ...
   private static final Map ITEM_TO_POT_TEXTURE;

   public static @Nullable ResourceKey getPatternFromItem(final Item item) {
   ...
   public static DecoratedPotPattern bootstrap(final Registry registry) {
   ...
   private static DecoratedPotPattern register(final Registry registry, final ResourceKey id, final String assetId) {
