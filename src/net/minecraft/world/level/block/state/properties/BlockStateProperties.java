...
public class BlockStateProperties {
   ...
   public static final EnumProperty FACING_HOPPER;
   ...
   public static final EnumProperty EAST_WALL;
   public static final EnumProperty NORTH_WALL;
   public static final EnumProperty SOUTH_WALL;
   public static final EnumProperty WEST_WALL;
   ...
   public static final EnumProperty DRIPSTONE_THICKNESS;
   ...
   public static final EnumProperty COPPER_GOLEM_POSE;
   ...
   static {
      ...
      SIDE_CHAIN_PART = EnumProperty.create("side_chain", SideChainPart.class);
      ...
      CREAKING_HEART_STATE = EnumProperty.create("creaking_heart_state", CreakingHeartState.class);
      OMINOUS = BooleanProperty.create("ominous");
      TEST_BLOCK_MODE = EnumProperty.create("mode", TestBlockMode.class);
      MAP = BooleanProperty.create("map");
      COPPER_GOLEM_POSE = EnumProperty.create("copper_golem_pose", CopperGolemStatueBlock.Pose.class);
   }
}
