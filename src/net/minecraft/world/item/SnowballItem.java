...
public class SnowballItem extends Item implements ProjectileItem {
   ...
   public InteractionResult use(final Level level, final Player player, final InteractionHand hand) {
      ...
      level.playSound((Entity)null, player.getX(), player.getY(), player.getZ(), (SoundEvent)SoundEvents.SNOWBALL_THROW, SoundSource.NEUTRAL, 0.5F, 0.4F / (level.getRandom().nextFloat() * 0.4F + 0.8F));
