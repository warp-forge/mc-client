...
public class Items {
   ...
   private static Function createBlockItemWithCustomItemName(final Block block) {
      return (p) -> new BlockItem(block, p.useItemDescriptionPrefix());
   }

   private static ResourceKey vanillaItemId(final String name) {
      return ResourceKey.create(Registries.ITEM, Identifier.withDefaultNamespace(name));
   }

   private static ResourceKey blockIdToItemId(final ResourceKey blockName) {
   ...
   private static Item registerBlock(final Block block, final UnaryOperator propertiesFunction) {
   ...
   private static Item registerBlock(final Block block, final BiFunction itemFactory) {
      return registerBlock(block, itemFactory, new Item.Properties());
   }

   private static Item registerBlock(final Block block, final BiFunction itemFactory, final Item.Properties properties) {
   ...
   private static Item registerItem(final String name, final Function itemFactory) {
      return registerItem(vanillaItemId(name), itemFactory, new Item.Properties());
   }

   private static Item registerItem(final String name, final Function itemFactory, final Item.Properties properties) {
   ...
   private static Item registerItem(final ResourceKey key, final Function itemFactory) {
      return registerItem(key, itemFactory, new Item.Properties());
   }

   private static Item registerItem(final ResourceKey key, final Function itemFactory, final Item.Properties properties) {
   ...
   static {
      ...
      LIGHT = registerBlock(Blocks.LIGHT, (UnaryOperator)((p) -> p.rarity(Rarity.EPIC).component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(LightBlock.LEVEL, (int)15))));
      ...
      MINECART = registerItem((String)"minecart", (p) -> new MinecartItem(EntityType.MINECART, p), (new Item.Properties()).stacksTo(1));
      CHEST_MINECART = registerItem((String)"chest_minecart", (p) -> new MinecartItem(EntityType.CHEST_MINECART, p), (new Item.Properties()).stacksTo(1));
      FURNACE_MINECART = registerItem((String)"furnace_minecart", (p) -> new MinecartItem(EntityType.FURNACE_MINECART, p), (new Item.Properties()).stacksTo(1));
      TNT_MINECART = registerItem((String)"tnt_minecart", (p) -> new MinecartItem(EntityType.TNT_MINECART, p), (new Item.Properties()).stacksTo(1));
      HOPPER_MINECART = registerItem((String)"hopper_minecart", (p) -> new MinecartItem(EntityType.HOPPER_MINECART, p), (new Item.Properties()).stacksTo(1));
      CARROT_ON_A_STICK = registerItem((String)"carrot_on_a_stick", (p) -> new FoodOnAStickItem(EntityType.PIG, 7, p), (new Item.Properties()).durability(25));
      WARPED_FUNGUS_ON_A_STICK = registerItem((String)"warped_fungus_on_a_stick", (p) -> new FoodOnAStickItem(EntityType.STRIDER, 1, p), (new Item.Properties()).durability(100));
      ...
      OAK_BOAT = registerItem((String)"oak_boat", (p) -> new BoatItem(EntityType.OAK_BOAT, p), (new Item.Properties()).stacksTo(1));
      OAK_CHEST_BOAT = registerItem((String)"oak_chest_boat", (p) -> new BoatItem(EntityType.OAK_CHEST_BOAT, p), (new Item.Properties()).stacksTo(1));
      SPRUCE_BOAT = registerItem((String)"spruce_boat", (p) -> new BoatItem(EntityType.SPRUCE_BOAT, p), (new Item.Properties()).stacksTo(1));
      SPRUCE_CHEST_BOAT = registerItem((String)"spruce_chest_boat", (p) -> new BoatItem(EntityType.SPRUCE_CHEST_BOAT, p), (new Item.Properties()).stacksTo(1));
      BIRCH_BOAT = registerItem((String)"birch_boat", (p) -> new BoatItem(EntityType.BIRCH_BOAT, p), (new Item.Properties()).stacksTo(1));
      BIRCH_CHEST_BOAT = registerItem((String)"birch_chest_boat", (p) -> new BoatItem(EntityType.BIRCH_CHEST_BOAT, p), (new Item.Properties()).stacksTo(1));
      JUNGLE_BOAT = registerItem((String)"jungle_boat", (p) -> new BoatItem(EntityType.JUNGLE_BOAT, p), (new Item.Properties()).stacksTo(1));
      JUNGLE_CHEST_BOAT = registerItem((String)"jungle_chest_boat", (p) -> new BoatItem(EntityType.JUNGLE_CHEST_BOAT, p), (new Item.Properties()).stacksTo(1));
      ACACIA_BOAT = registerItem((String)"acacia_boat", (p) -> new BoatItem(EntityType.ACACIA_BOAT, p), (new Item.Properties()).stacksTo(1));
      ACACIA_CHEST_BOAT = registerItem((String)"acacia_chest_boat", (p) -> new BoatItem(EntityType.ACACIA_CHEST_BOAT, p), (new Item.Properties()).stacksTo(1));
      CHERRY_BOAT = registerItem((String)"cherry_boat", (p) -> new BoatItem(EntityType.CHERRY_BOAT, p), (new Item.Properties()).stacksTo(1));
      CHERRY_CHEST_BOAT = registerItem((String)"cherry_chest_boat", (p) -> new BoatItem(EntityType.CHERRY_CHEST_BOAT, p), (new Item.Properties()).stacksTo(1));
      DARK_OAK_BOAT = registerItem((String)"dark_oak_boat", (p) -> new BoatItem(EntityType.DARK_OAK_BOAT, p), (new Item.Properties()).stacksTo(1));
      DARK_OAK_CHEST_BOAT = registerItem((String)"dark_oak_chest_boat", (p) -> new BoatItem(EntityType.DARK_OAK_CHEST_BOAT, p), (new Item.Properties()).stacksTo(1));
      PALE_OAK_BOAT = registerItem((String)"pale_oak_boat", (p) -> new BoatItem(EntityType.PALE_OAK_BOAT, p), (new Item.Properties()).stacksTo(1));
      PALE_OAK_CHEST_BOAT = registerItem((String)"pale_oak_chest_boat", (p) -> new BoatItem(EntityType.PALE_OAK_CHEST_BOAT, p), (new Item.Properties()).stacksTo(1));
      MANGROVE_BOAT = registerItem((String)"mangrove_boat", (p) -> new BoatItem(EntityType.MANGROVE_BOAT, p), (new Item.Properties()).stacksTo(1));
      MANGROVE_CHEST_BOAT = registerItem((String)"mangrove_chest_boat", (p) -> new BoatItem(EntityType.MANGROVE_CHEST_BOAT, p), (new Item.Properties()).stacksTo(1));
      BAMBOO_RAFT = registerItem((String)"bamboo_raft", (p) -> new BoatItem(EntityType.BAMBOO_RAFT, p), (new Item.Properties()).stacksTo(1));
      BAMBOO_CHEST_RAFT = registerItem((String)"bamboo_chest_raft", (p) -> new BoatItem(EntityType.BAMBOO_CHEST_RAFT, p), (new Item.Properties()).stacksTo(1));
      ...
      TEST_BLOCK = registerBlock(Blocks.TEST_BLOCK, GameMasterBlockItem::new, (new Item.Properties()).rarity(Rarity.EPIC).component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(TestBlock.MODE, (Comparable)TestBlockMode.START)));
      ...
      WOODEN_SHOVEL = registerItem((String)"wooden_shovel", (Function)((p) -> new ShovelItem(ToolMaterial.WOOD, 1.5F, -3.0F, p)));
      WOODEN_PICKAXE = registerItem("wooden_pickaxe", (new Item.Properties()).pickaxe(ToolMaterial.WOOD, 1.0F, -2.8F));
      WOODEN_AXE = registerItem((String)"wooden_axe", (Function)((p) -> new AxeItem(ToolMaterial.WOOD, 6.0F, -3.2F, p)));
      WOODEN_HOE = registerItem((String)"wooden_hoe", (Function)((p) -> new HoeItem(ToolMaterial.WOOD, 0.0F, -3.0F, p)));
      COPPER_SWORD = registerItem("copper_sword", (new Item.Properties()).sword(ToolMaterial.COPPER, 3.0F, -2.4F));
      COPPER_SHOVEL = registerItem((String)"copper_shovel", (Function)((p) -> new ShovelItem(ToolMaterial.COPPER, 1.5F, -3.0F, p)));
      COPPER_PICKAXE = registerItem("copper_pickaxe", (new Item.Properties()).pickaxe(ToolMaterial.COPPER, 1.0F, -2.8F));
      COPPER_AXE = registerItem((String)"copper_axe", (Function)((p) -> new AxeItem(ToolMaterial.COPPER, 7.0F, -3.2F, p)));
      COPPER_HOE = registerItem((String)"copper_hoe", (Function)((p) -> new HoeItem(ToolMaterial.COPPER, -1.0F, -2.0F, p)));
      STONE_SWORD = registerItem("stone_sword", (new Item.Properties()).sword(ToolMaterial.STONE, 3.0F, -2.4F));
      STONE_SHOVEL = registerItem((String)"stone_shovel", (Function)((p) -> new ShovelItem(ToolMaterial.STONE, 1.5F, -3.0F, p)));
      STONE_PICKAXE = registerItem("stone_pickaxe", (new Item.Properties()).pickaxe(ToolMaterial.STONE, 1.0F, -2.8F));
      STONE_AXE = registerItem((String)"stone_axe", (Function)((p) -> new AxeItem(ToolMaterial.STONE, 7.0F, -3.2F, p)));
      STONE_HOE = registerItem((String)"stone_hoe", (Function)((p) -> new HoeItem(ToolMaterial.STONE, -1.0F, -2.0F, p)));
      GOLDEN_SWORD = registerItem("golden_sword", (new Item.Properties()).sword(ToolMaterial.GOLD, 3.0F, -2.4F));
      GOLDEN_SHOVEL = registerItem((String)"golden_shovel", (Function)((p) -> new ShovelItem(ToolMaterial.GOLD, 1.5F, -3.0F, p)));
      GOLDEN_PICKAXE = registerItem("golden_pickaxe", (new Item.Properties()).pickaxe(ToolMaterial.GOLD, 1.0F, -2.8F));
      GOLDEN_AXE = registerItem((String)"golden_axe", (Function)((p) -> new AxeItem(ToolMaterial.GOLD, 6.0F, -3.0F, p)));
      GOLDEN_HOE = registerItem((String)"golden_hoe", (Function)((p) -> new HoeItem(ToolMaterial.GOLD, 0.0F, -3.0F, p)));
      IRON_SWORD = registerItem("iron_sword", (new Item.Properties()).sword(ToolMaterial.IRON, 3.0F, -2.4F));
      IRON_SHOVEL = registerItem((String)"iron_shovel", (Function)((p) -> new ShovelItem(ToolMaterial.IRON, 1.5F, -3.0F, p)));
      IRON_PICKAXE = registerItem("iron_pickaxe", (new Item.Properties()).pickaxe(ToolMaterial.IRON, 1.0F, -2.8F));
      IRON_AXE = registerItem((String)"iron_axe", (Function)((p) -> new AxeItem(ToolMaterial.IRON, 6.0F, -3.1F, p)));
      IRON_HOE = registerItem((String)"iron_hoe", (Function)((p) -> new HoeItem(ToolMaterial.IRON, -2.0F, -1.0F, p)));
      DIAMOND_SWORD = registerItem("diamond_sword", (new Item.Properties()).sword(ToolMaterial.DIAMOND, 3.0F, -2.4F));
      DIAMOND_SHOVEL = registerItem((String)"diamond_shovel", (Function)((p) -> new ShovelItem(ToolMaterial.DIAMOND, 1.5F, -3.0F, p)));
      DIAMOND_PICKAXE = registerItem("diamond_pickaxe", (new Item.Properties()).pickaxe(ToolMaterial.DIAMOND, 1.0F, -2.8F));
      DIAMOND_AXE = registerItem((String)"diamond_axe", (Function)((p) -> new AxeItem(ToolMaterial.DIAMOND, 5.0F, -3.0F, p)));
      DIAMOND_HOE = registerItem((String)"diamond_hoe", (Function)((p) -> new HoeItem(ToolMaterial.DIAMOND, -3.0F, 0.0F, p)));
      NETHERITE_SWORD = registerItem("netherite_sword", (new Item.Properties()).sword(ToolMaterial.NETHERITE, 3.0F, -2.4F).fireResistant());
      NETHERITE_SHOVEL = registerItem((String)"netherite_shovel", (p) -> new ShovelItem(ToolMaterial.NETHERITE, 1.5F, -3.0F, p), (new Item.Properties()).fireResistant());
      ...
      NETHERITE_AXE = registerItem((String)"netherite_axe", (p) -> new AxeItem(ToolMaterial.NETHERITE, 5.0F, -3.0F, p), (new Item.Properties()).fireResistant());
      NETHERITE_HOE = registerItem((String)"netherite_hoe", (p) -> new HoeItem(ToolMaterial.NETHERITE, -4.0F, 0.0F, p), (new Item.Properties()).fireResistant());
      ...
      PAINTING = registerItem((String)"painting", (Function)((p) -> new HangingEntityItem(EntityType.PAINTING, p)));
      ...
      BUCKET = registerItem((String)"bucket", (p) -> new BucketItem(Fluids.EMPTY, p), (new Item.Properties()).stacksTo(16));
      WATER_BUCKET = registerItem((String)"water_bucket", (p) -> new BucketItem(Fluids.WATER, p), (new Item.Properties()).craftRemainder(BUCKET).stacksTo(1));
      LAVA_BUCKET = registerItem((String)"lava_bucket", (p) -> new BucketItem(Fluids.LAVA, p), (new Item.Properties()).craftRemainder(BUCKET).stacksTo(1));
      POWDER_SNOW_BUCKET = registerItem((String)"powder_snow_bucket", (p) -> new SolidBucketItem(Blocks.POWDER_SNOW, SoundEvents.BUCKET_EMPTY_POWDER_SNOW, p), (new Item.Properties()).stacksTo(1).useItemDescriptionPrefix());
      ...
      PUFFERFISH_BUCKET = registerItem((String)"pufferfish_bucket", (p) -> new MobBucketItem(EntityType.PUFFERFISH, Fluids.WATER, SoundEvents.BUCKET_EMPTY_FISH, p), (new Item.Properties()).stacksTo(1).component(DataComponents.BUCKET_ENTITY_DATA, CustomData.EMPTY).component(DataComponents.FOOD, Foods.PUFFERFISH));
      SALMON_BUCKET = registerItem((String)"salmon_bucket", (p) -> new MobBucketItem(EntityType.SALMON, Fluids.WATER, SoundEvents.BUCKET_EMPTY_FISH, p), (new Item.Properties()).stacksTo(1).component(DataComponents.BUCKET_ENTITY_DATA, CustomData.EMPTY).component(DataComponents.FOOD, Foods.SALMON));
      COD_BUCKET = registerItem((String)"cod_bucket", (p) -> new MobBucketItem(EntityType.COD, Fluids.WATER, SoundEvents.BUCKET_EMPTY_FISH, p), (new Item.Properties()).stacksTo(1).component(DataComponents.BUCKET_ENTITY_DATA, CustomData.EMPTY).component(DataComponents.FOOD, Foods.COD));
      TROPICAL_FISH_BUCKET = registerItem((String)"tropical_fish_bucket", (p) -> new MobBucketItem(EntityType.TROPICAL_FISH, Fluids.WATER, SoundEvents.BUCKET_EMPTY_FISH, p), (new Item.Properties()).stacksTo(1).component(DataComponents.BUCKET_ENTITY_DATA, CustomData.EMPTY).component(DataComponents.FOOD, Foods.TROPICAL_FISH));
      AXOLOTL_BUCKET = registerItem((String)"axolotl_bucket", (p) -> new MobBucketItem(EntityType.AXOLOTL, Fluids.WATER, SoundEvents.BUCKET_EMPTY_AXOLOTL, p), (new Item.Properties()).stacksTo(1).component(DataComponents.BUCKET_ENTITY_DATA, CustomData.EMPTY));
      TADPOLE_BUCKET = registerItem((String)"tadpole_bucket", (p) -> new MobBucketItem(EntityType.TADPOLE, Fluids.WATER, SoundEvents.BUCKET_EMPTY_TADPOLE, p), (new Item.Properties()).stacksTo(1).component(DataComponents.BUCKET_ENTITY_DATA, CustomData.EMPTY));
      ...
      ITEM_FRAME = registerItem((String)"item_frame", (Function)((p) -> new ItemFrameItem(EntityType.ITEM_FRAME, p)));
      GLOW_ITEM_FRAME = registerItem((String)"glow_item_frame", (Function)((p) -> new ItemFrameItem(EntityType.GLOW_ITEM_FRAME, p)));
      ...
      COMMAND_BLOCK_MINECART = registerItem((String)"command_block_minecart", (p) -> new MinecartItem(EntityType.COMMAND_BLOCK_MINECART, p), (new Item.Properties()).stacksTo(1).rarity(Rarity.EPIC));
      ...
      BEE_NEST = registerBlock(Blocks.BEE_NEST, (new Item.Properties()).component(DataComponents.BEES, Bees.EMPTY).component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(BeehiveBlock.HONEY_LEVEL, (int)0)));
      BEEHIVE = registerBlock(Blocks.BEEHIVE, (new Item.Properties()).component(DataComponents.BEES, Bees.EMPTY).component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(BeehiveBlock.HONEY_LEVEL, (int)0)));
      ...
      COPPER_GOLEM_STATUE = registerBlock(Blocks.COPPER_GOLEM_STATUE, (new Item.Properties()).component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(CopperGolemStatueBlock.POSE, (Comparable)CopperGolemStatueBlock.Pose.STANDING)));
      EXPOSED_COPPER_GOLEM_STATUE = registerBlock(Blocks.EXPOSED_COPPER_GOLEM_STATUE, (new Item.Properties()).component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(CopperGolemStatueBlock.POSE, (Comparable)CopperGolemStatueBlock.Pose.STANDING)));
      WEATHERED_COPPER_GOLEM_STATUE = registerBlock(Blocks.WEATHERED_COPPER_GOLEM_STATUE, (new Item.Properties()).component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(CopperGolemStatueBlock.POSE, (Comparable)CopperGolemStatueBlock.Pose.STANDING)));
      OXIDIZED_COPPER_GOLEM_STATUE = registerBlock(Blocks.OXIDIZED_COPPER_GOLEM_STATUE, (new Item.Properties()).component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(CopperGolemStatueBlock.POSE, (Comparable)CopperGolemStatueBlock.Pose.STANDING)));
      WAXED_COPPER_GOLEM_STATUE = registerBlock(Blocks.WAXED_COPPER_GOLEM_STATUE, (new Item.Properties()).component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(CopperGolemStatueBlock.POSE, (Comparable)CopperGolemStatueBlock.Pose.STANDING)));
      WAXED_EXPOSED_COPPER_GOLEM_STATUE = registerBlock(Blocks.WAXED_EXPOSED_COPPER_GOLEM_STATUE, (new Item.Properties()).component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(CopperGolemStatueBlock.POSE, (Comparable)CopperGolemStatueBlock.Pose.STANDING)));
      WAXED_WEATHERED_COPPER_GOLEM_STATUE = registerBlock(Blocks.WAXED_WEATHERED_COPPER_GOLEM_STATUE, (new Item.Properties()).component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(CopperGolemStatueBlock.POSE, (Comparable)CopperGolemStatueBlock.Pose.STANDING)));
      WAXED_OXIDIZED_COPPER_GOLEM_STATUE = registerBlock(Blocks.WAXED_OXIDIZED_COPPER_GOLEM_STATUE, (new Item.Properties()).component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(CopperGolemStatueBlock.POSE, (Comparable)CopperGolemStatueBlock.Pose.STANDING)));
