...
public class FrogAi {
   ...
   private static ActivityData initTongueActivity() {
      return ActivityData.create(Activity.TONGUE, 0, ImmutableList.of(StopAttackingIfTargetInvalid.create(), new ShootTongue(SoundEvents.FROG_TONGUE, SoundEvents.FROG_EAT)), (MemoryModuleType)MemoryModuleType.ATTACK_TARGET);
   }

   private static boolean isAcceptableLandingSpot(final Mob body, final BlockPos targetPos) {
