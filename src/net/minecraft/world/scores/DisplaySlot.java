...
public enum DisplaySlot implements StringRepresentable {
   ...
   public static final StringRepresentable.EnumCodec CODEC = StringRepresentable.fromEnum(DisplaySlot::values);
   public static final IntFunction BY_ID = ByIdMap.continuous(DisplaySlot::id, values(), ByIdMap.OutOfBoundsStrategy.ZERO);
