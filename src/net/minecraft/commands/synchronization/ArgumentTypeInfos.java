...
public class ArgumentTypeInfos {
   ...
   private static ArgumentTypeInfo register(final Registry registry, final String id, final Class brigadierType, final ArgumentTypeInfo info) {
      BY_CLASS.put(brigadierType, info);
      return (ArgumentTypeInfo)Registry.register(registry, (String)id, info);
   }

   public static ArgumentTypeInfo bootstrap(final Registry registry) {
   ...
   private static Class fixClassType(final Class cls) {
      return cls;
   }
   ...
   public static ArgumentTypeInfo byClass(final ArgumentType argumentType) {
   ...
   public static ArgumentTypeInfo.Template unpack(final ArgumentType argumentType) {
