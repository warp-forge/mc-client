...
public class AquaticFeatures {
   public static final ResourceKey SEAGRASS_SHORT = FeatureUtils.createKey("seagrass_short");
   public static final ResourceKey SEAGRASS_SLIGHTLY_LESS_SHORT = FeatureUtils.createKey("seagrass_slightly_less_short");
   public static final ResourceKey SEAGRASS_MID = FeatureUtils.createKey("seagrass_mid");
   public static final ResourceKey SEAGRASS_TALL = FeatureUtils.createKey("seagrass_tall");
   public static final ResourceKey SEA_PICKLE = FeatureUtils.createKey("sea_pickle");
   public static final ResourceKey KELP = FeatureUtils.createKey("kelp");
   public static final ResourceKey WARM_OCEAN_VEGETATION = FeatureUtils.createKey("warm_ocean_vegetation");
