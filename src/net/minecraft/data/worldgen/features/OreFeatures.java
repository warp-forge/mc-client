...
public class OreFeatures {
   public static final ResourceKey ORE_MAGMA = FeatureUtils.createKey("ore_magma");
   public static final ResourceKey ORE_SOUL_SAND = FeatureUtils.createKey("ore_soul_sand");
   public static final ResourceKey ORE_NETHER_GOLD = FeatureUtils.createKey("ore_nether_gold");
   public static final ResourceKey ORE_QUARTZ = FeatureUtils.createKey("ore_quartz");
   public static final ResourceKey ORE_GRAVEL_NETHER = FeatureUtils.createKey("ore_gravel_nether");
   public static final ResourceKey ORE_BLACKSTONE = FeatureUtils.createKey("ore_blackstone");
   public static final ResourceKey ORE_DIRT = FeatureUtils.createKey("ore_dirt");
   public static final ResourceKey ORE_GRAVEL = FeatureUtils.createKey("ore_gravel");
   public static final ResourceKey ORE_GRANITE = FeatureUtils.createKey("ore_granite");
   public static final ResourceKey ORE_DIORITE = FeatureUtils.createKey("ore_diorite");
   public static final ResourceKey ORE_ANDESITE = FeatureUtils.createKey("ore_andesite");
   public static final ResourceKey ORE_TUFF = FeatureUtils.createKey("ore_tuff");
   public static final ResourceKey ORE_COAL = FeatureUtils.createKey("ore_coal");
   public static final ResourceKey ORE_COAL_BURIED = FeatureUtils.createKey("ore_coal_buried");
   public static final ResourceKey ORE_IRON = FeatureUtils.createKey("ore_iron");
   public static final ResourceKey ORE_IRON_SMALL = FeatureUtils.createKey("ore_iron_small");
   public static final ResourceKey ORE_GOLD = FeatureUtils.createKey("ore_gold");
   public static final ResourceKey ORE_GOLD_BURIED = FeatureUtils.createKey("ore_gold_buried");
   public static final ResourceKey ORE_REDSTONE = FeatureUtils.createKey("ore_redstone");
   public static final ResourceKey ORE_DIAMOND_SMALL = FeatureUtils.createKey("ore_diamond_small");
   public static final ResourceKey ORE_DIAMOND_MEDIUM = FeatureUtils.createKey("ore_diamond_medium");
   public static final ResourceKey ORE_DIAMOND_LARGE = FeatureUtils.createKey("ore_diamond_large");
   public static final ResourceKey ORE_DIAMOND_BURIED = FeatureUtils.createKey("ore_diamond_buried");
   public static final ResourceKey ORE_LAPIS = FeatureUtils.createKey("ore_lapis");
   public static final ResourceKey ORE_LAPIS_BURIED = FeatureUtils.createKey("ore_lapis_buried");
   public static final ResourceKey ORE_INFESTED = FeatureUtils.createKey("ore_infested");
   public static final ResourceKey ORE_EMERALD = FeatureUtils.createKey("ore_emerald");
   public static final ResourceKey ORE_ANCIENT_DEBRIS_LARGE = FeatureUtils.createKey("ore_ancient_debris_large");
   public static final ResourceKey ORE_ANCIENT_DEBRIS_SMALL = FeatureUtils.createKey("ore_ancient_debris_small");
   public static final ResourceKey ORE_COPPPER_SMALL = FeatureUtils.createKey("ore_copper_small");
   public static final ResourceKey ORE_COPPER_LARGE = FeatureUtils.createKey("ore_copper_large");
   public static final ResourceKey ORE_CLAY = FeatureUtils.createKey("ore_clay");
