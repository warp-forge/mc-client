...
public class MiscOverworldPlacements {
   public static final ResourceKey ICE_SPIKE = PlacementUtils.createKey("ice_spike");
   public static final ResourceKey ICE_PATCH = PlacementUtils.createKey("ice_patch");
   public static final ResourceKey FOREST_ROCK = PlacementUtils.createKey("forest_rock");
   public static final ResourceKey ICEBERG_PACKED = PlacementUtils.createKey("iceberg_packed");
   public static final ResourceKey ICEBERG_BLUE = PlacementUtils.createKey("iceberg_blue");
   public static final ResourceKey BLUE_ICE = PlacementUtils.createKey("blue_ice");
   public static final ResourceKey LAKE_LAVA_UNDERGROUND = PlacementUtils.createKey("lake_lava_underground");
   public static final ResourceKey LAKE_LAVA_SURFACE = PlacementUtils.createKey("lake_lava_surface");
   public static final ResourceKey DISK_CLAY = PlacementUtils.createKey("disk_clay");
   public static final ResourceKey DISK_GRAVEL = PlacementUtils.createKey("disk_gravel");
   public static final ResourceKey DISK_SAND = PlacementUtils.createKey("disk_sand");
   public static final ResourceKey DISK_GRASS = PlacementUtils.createKey("disk_grass");
   public static final ResourceKey FREEZE_TOP_LAYER = PlacementUtils.createKey("freeze_top_layer");
   public static final ResourceKey VOID_START_PLATFORM = PlacementUtils.createKey("void_start_platform");
   public static final ResourceKey DESERT_WELL = PlacementUtils.createKey("desert_well");
   public static final ResourceKey SPRING_LAVA = PlacementUtils.createKey("spring_lava");
   public static final ResourceKey SPRING_LAVA_FROZEN = PlacementUtils.createKey("spring_lava_frozen");
   public static final ResourceKey SPRING_WATER = PlacementUtils.createKey("spring_water");
