...
public class TreePlacements {
   public static final ResourceKey CRIMSON_FUNGI = PlacementUtils.createKey("crimson_fungi");
   public static final ResourceKey WARPED_FUNGI = PlacementUtils.createKey("warped_fungi");
   public static final ResourceKey OAK_CHECKED = PlacementUtils.createKey("oak_checked");
   public static final ResourceKey DARK_OAK_CHECKED = PlacementUtils.createKey("dark_oak_checked");
   public static final ResourceKey PALE_OAK_CHECKED = PlacementUtils.createKey("pale_oak_checked");
   public static final ResourceKey PALE_OAK_CREAKING_CHECKED = PlacementUtils.createKey("pale_oak_creaking_checked");
   public static final ResourceKey BIRCH_CHECKED = PlacementUtils.createKey("birch_checked");
   public static final ResourceKey ACACIA_CHECKED = PlacementUtils.createKey("acacia_checked");
   public static final ResourceKey SPRUCE_CHECKED = PlacementUtils.createKey("spruce_checked");
   public static final ResourceKey MANGROVE_CHECKED = PlacementUtils.createKey("mangrove_checked");
   public static final ResourceKey CHERRY_CHECKED = PlacementUtils.createKey("cherry_checked");
   public static final ResourceKey PINE_ON_SNOW = PlacementUtils.createKey("pine_on_snow");
   public static final ResourceKey SPRUCE_ON_SNOW = PlacementUtils.createKey("spruce_on_snow");
   public static final ResourceKey PINE_CHECKED = PlacementUtils.createKey("pine_checked");
   public static final ResourceKey JUNGLE_TREE_CHECKED = PlacementUtils.createKey("jungle_tree");
   public static final ResourceKey FANCY_OAK_CHECKED = PlacementUtils.createKey("fancy_oak_checked");
   public static final ResourceKey MEGA_JUNGLE_TREE_CHECKED = PlacementUtils.createKey("mega_jungle_tree_checked");
   public static final ResourceKey MEGA_SPRUCE_CHECKED = PlacementUtils.createKey("mega_spruce_checked");
   public static final ResourceKey MEGA_PINE_CHECKED = PlacementUtils.createKey("mega_pine_checked");
   public static final ResourceKey TALL_MANGROVE_CHECKED = PlacementUtils.createKey("tall_mangrove_checked");
   public static final ResourceKey JUNGLE_BUSH = PlacementUtils.createKey("jungle_bush");
   public static final ResourceKey SUPER_BIRCH_BEES_0002 = PlacementUtils.createKey("super_birch_bees_0002");
   public static final ResourceKey SUPER_BIRCH_BEES = PlacementUtils.createKey("super_birch_bees");
   public static final ResourceKey OAK_BEES_0002_LEAF_LITTER = PlacementUtils.createKey("oak_bees_0002_leaf_litter");
   public static final ResourceKey OAK_BEES_002 = PlacementUtils.createKey("oak_bees_002");
   public static final ResourceKey BIRCH_BEES_0002_PLACED = PlacementUtils.createKey("birch_bees_0002");
   public static final ResourceKey BIRCH_BEES_0002_LEAF_LITTER = PlacementUtils.createKey("birch_bees_0002_leaf_litter");
   public static final ResourceKey BIRCH_BEES_002 = PlacementUtils.createKey("birch_bees_002");
   public static final ResourceKey FANCY_OAK_BEES_0002_LEAF_LITTER = PlacementUtils.createKey("fancy_oak_bees_0002_leaf_litter");
   public static final ResourceKey FANCY_OAK_BEES_002 = PlacementUtils.createKey("fancy_oak_bees_002");
   public static final ResourceKey FANCY_OAK_BEES = PlacementUtils.createKey("fancy_oak_bees");
   public static final ResourceKey CHERRY_BEES_005 = PlacementUtils.createKey("cherry_bees_005");
   public static final ResourceKey OAK_LEAF_LITTER = PlacementUtils.createKey("oak_leaf_litter");
   public static final ResourceKey DARK_OAK_LEAF_LITTER = PlacementUtils.createKey("dark_oak_leaf_litter");
   public static final ResourceKey BIRCH_LEAF_LITTER = PlacementUtils.createKey("birch_leaf_litter");
   public static final ResourceKey FANCY_OAK_LEAF_LITTER = PlacementUtils.createKey("fancy_oak_leaf_litter");
   public static final ResourceKey FALLEN_OAK_TREE = PlacementUtils.createKey("fallen_oak_tree");
   public static final ResourceKey FALLEN_BIRCH_TREE = PlacementUtils.createKey("fallen_birch_tree");
   public static final ResourceKey FALLEN_SUPER_BIRCH_TREE = PlacementUtils.createKey("fallen_super_birch_tree");
   public static final ResourceKey FALLEN_SPRUCE_TREE = PlacementUtils.createKey("fallen_spruce_tree");
   public static final ResourceKey FALLEN_JUNGLE_TREE = PlacementUtils.createKey("fallen_jungle_tree");
