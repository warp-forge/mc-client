...
public class CavePlacements {
   public static final ResourceKey MONSTER_ROOM = PlacementUtils.createKey("monster_room");
   public static final ResourceKey MONSTER_ROOM_DEEP = PlacementUtils.createKey("monster_room_deep");
   public static final ResourceKey FOSSIL_UPPER = PlacementUtils.createKey("fossil_upper");
   public static final ResourceKey FOSSIL_LOWER = PlacementUtils.createKey("fossil_lower");
   public static final ResourceKey DRIPSTONE_CLUSTER = PlacementUtils.createKey("dripstone_cluster");
   public static final ResourceKey LARGE_DRIPSTONE = PlacementUtils.createKey("large_dripstone");
   public static final ResourceKey POINTED_DRIPSTONE = PlacementUtils.createKey("pointed_dripstone");
   public static final ResourceKey UNDERWATER_MAGMA = PlacementUtils.createKey("underwater_magma");
   public static final ResourceKey GLOW_LICHEN = PlacementUtils.createKey("glow_lichen");
   public static final ResourceKey ROOTED_AZALEA_TREE = PlacementUtils.createKey("rooted_azalea_tree");
   public static final ResourceKey CAVE_VINES = PlacementUtils.createKey("cave_vines");
   public static final ResourceKey LUSH_CAVES_VEGETATION = PlacementUtils.createKey("lush_caves_vegetation");
   public static final ResourceKey LUSH_CAVES_CLAY = PlacementUtils.createKey("lush_caves_clay");
   public static final ResourceKey LUSH_CAVES_CEILING_VEGETATION = PlacementUtils.createKey("lush_caves_ceiling_vegetation");
   public static final ResourceKey SPORE_BLOSSOM = PlacementUtils.createKey("spore_blossom");
   public static final ResourceKey CLASSIC_VINES = PlacementUtils.createKey("classic_vines_cave_feature");
   public static final ResourceKey AMETHYST_GEODE = PlacementUtils.createKey("amethyst_geode");
   public static final ResourceKey SCULK_PATCH_DEEP_DARK = PlacementUtils.createKey("sculk_patch_deep_dark");
   public static final ResourceKey SCULK_PATCH_ANCIENT_CITY = PlacementUtils.createKey("sculk_patch_ancient_city");
   public static final ResourceKey SCULK_VEIN = PlacementUtils.createKey("sculk_vein");
