...
public class Carvers {
   public static final ResourceKey CAVE = createKey("cave");
   public static final ResourceKey CAVE_EXTRA_UNDERGROUND = createKey("cave_extra_underground");
   public static final ResourceKey CANYON = createKey("canyon");
   public static final ResourceKey NETHER_CAVE = createKey("nether_cave");
