...
public class Structures {
   public static void bootstrap(final BootstrapContext context) {
      ...
      context.register(BuiltinStructures.PILLAGER_OUTPOST, new JigsawStructure((new Structure.StructureSettings.Builder(biomes.getOrThrow(BiomeTags.HAS_PILLAGER_OUTPOST))).spawnOverrides(Map.of(MobCategory.MONSTER, new StructureSpawnOverride(StructureSpawnOverride.BoundingBoxType.STRUCTURE, WeightedList.of((Object)(new MobSpawnSettings.SpawnerData(EntityType.PILLAGER, 1, 1)))))).terrainAdapation(TerrainAdjustment.BEARD_THIN).build(), templates.getOrThrow(PillagerOutpostPools.START), 7, ConstantHeight.of(VerticalAnchor.absolute(0)), true, Heightmap.Types.WORLD_SURFACE_WG));
      ...
      context.register(BuiltinStructures.SWAMP_HUT, new SwampHutStructure((new Structure.StructureSettings.Builder(biomes.getOrThrow(BiomeTags.HAS_SWAMP_HUT))).spawnOverrides(Map.of(MobCategory.MONSTER, new StructureSpawnOverride(StructureSpawnOverride.BoundingBoxType.PIECE, WeightedList.of((Object)(new MobSpawnSettings.SpawnerData(EntityType.WITCH, 1, 1)))), MobCategory.CREATURE, new StructureSpawnOverride(StructureSpawnOverride.BoundingBoxType.PIECE, WeightedList.of((Object)(new MobSpawnSettings.SpawnerData(EntityType.CAT, 1, 1)))))).build()));
