...
public class ModelLayers {
   ...
   private static final Set ALL_MODELS = Sets.newHashSet();
   ...
   public static final ArmorModelSet ARMOR_STAND_ARMOR = registerArmorSet("armor_stand");
   public static final ModelLayerLocation ARMOR_STAND_SMALL = register("armor_stand_small");
   public static final ArmorModelSet ARMOR_STAND_SMALL_ARMOR = registerArmorSet("armor_stand_small");
   ...
   public static final ArmorModelSet BOGGED_ARMOR = registerArmorSet("bogged");
   ...
   public static final ArmorModelSet DROWNED_BABY_ARMOR = registerArmorSet("drowned_baby");
   public static final ModelLayerLocation DROWNED_BABY_OUTER_LAYER = register("drowned_baby", "outer");
   public static final ArmorModelSet DROWNED_ARMOR = registerArmorSet("drowned");
   ...
   public static final ArmorModelSet GIANT_ARMOR = registerArmorSet("giant");
   ...
   public static final ArmorModelSet HUSK_BABY_ARMOR = registerArmorSet("husk_baby");
   public static final ArmorModelSet HUSK_ARMOR = registerArmorSet("husk");
   ...
   public static final ArmorModelSet PARCHED_ARMOR = registerArmorSet("parched");
   ...
   public static final ArmorModelSet PIGLIN_BABY_ARMOR = registerArmorSet("piglin_baby");
   public static final ModelLayerLocation PIGLIN_BRUTE = register("piglin_brute");
   public static final ArmorModelSet PIGLIN_BRUTE_ARMOR = registerArmorSet("piglin_brute");
   public static final ModelLayerLocation PIGLIN_HEAD = register("piglin_head");
   public static final ArmorModelSet PIGLIN_ARMOR = registerArmorSet("piglin");
   ...
   public static final ArmorModelSet PLAYER_ARMOR = registerArmorSet("player");
   public static final ModelLayerLocation PLAYER_SLIM = register("player_slim");
   public static final ArmorModelSet PLAYER_SLIM_ARMOR = registerArmorSet("player_slim");
   ...
   public static final ArmorModelSet SKELETON_ARMOR = registerArmorSet("skeleton");
   ...
   public static final ArmorModelSet STRAY_ARMOR = registerArmorSet("stray");
   ...
   public static final ArmorModelSet WITHER_SKELETON_ARMOR = registerArmorSet("wither_skeleton");
   ...
   public static final ArmorModelSet ZOMBIE_BABY_ARMOR = registerArmorSet("zombie_baby");
   ...
   public static final ArmorModelSet ZOMBIE_ARMOR = registerArmorSet("zombie");
   ...
   public static final ArmorModelSet ZOMBIE_VILLAGER_BABY_ARMOR = registerArmorSet("zombie_villager_baby");
   public static final ArmorModelSet ZOMBIE_VILLAGER_ARMOR = registerArmorSet("zombie_villager");
   ...
   public static final ArmorModelSet ZOMBIFIED_PIGLIN_BABY_ARMOR = registerArmorSet("zombified_piglin_baby");
   public static final ArmorModelSet ZOMBIFIED_PIGLIN_ARMOR = registerArmorSet("zombified_piglin");
   ...
   private static ArmorModelSet registerArmorSet(final String modelId) {
